This CNN was constructed as part of the curriculum of Udacity's Deep Learning Nanodegree.  The CNN takes a photo as input and classes the photo into one of three groups:
1. a dog;
2. a (human) face; or
3. something else.
